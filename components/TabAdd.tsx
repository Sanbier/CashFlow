    ...
    return (
        <div className="space-y-8 animate-fadeIn">
            ...
            <div className="glass-panel rounded-[32px] p-6 relative overflow-hidden group">
                ...
                <div className="flex items-center gap-2 text-green-700 font-black mb-4 uppercase text-xs tracking-widest relative z-10"><TrendingUp size={16}/> 1. Thu Nhập</div>
            ...
            <div className="glass-panel rounded-[32px] p-6 relative overflow-hidden group">
                ...
                <div className="flex items-center justify-between mb-4 relative z-10">
                    <div className="flex items-center gap-2 text-red-600 font-black uppercase text-xs tracking-widest"><TrendingDown size={16}/> 2. Chi Tiêu</div>
